...
inside_model(longitude = san_fran$meta$longitude, latitude = san_fran$meta$latitude)
```
...
```{r echo=TRUE}
bs_monitor <- grid_createMonitor(bs, longitude = san_fran$meta$longitude, latitude = san_fran$meta$latitude, radius = 2000)
```
...
As an example let's see how the BlueSky model (at the same location of the San Fransico model) compares to our San Fransico model. Red is the BlueSky model, blue is our San Fransico model. 
```{r echo=TRUE}
monitorPlot_timeseries(san_fran, col = 'blue')
