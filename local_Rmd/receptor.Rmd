...
raster_facet( bs_cropped[[1:24]], breaks = breaks, direction = -1)
```
...
breaks <- seq(from = 0, to = 250, length.out = 12)
raster_facet( bs_cropped[[25:48]], breaks = breaks, direction = -1)
```
...
breaks <- seq(from = 0, to = 250, length.out = 12)
raster_facet( bs_cropped[[49:72]], breaks = breaks, direction = -1)
```
