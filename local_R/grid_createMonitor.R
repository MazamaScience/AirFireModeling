#' @keywords ws_monitor
#' @export
#' @title Collapse a bs_grid object into a ws_monitor Object with a Single Monitor
#' @param bs_grid data list of class \code{bs_grid}
...
#' @description When given a bs_grid object, the function collapses all the data into a single timeseries using the function
...
grid_createMonitor <- function(bs_grid, longitude=stats::median(bs_grid$longitude), latitude=stats::median(bs_grid$latitude),
