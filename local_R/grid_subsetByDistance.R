# #' @keywords ws_grid
# #' @export
# #' @title Subset a \code{ws_grid} Data List by Distance from a Location 
...
# grid_subsetByDistance <- function(ws_grid, longitude=NULL, latitude=NULL, radius=20, count=NULL) {
...
#   distanceGrid <- grid_distance(ws_grid, longitude, latitude)
