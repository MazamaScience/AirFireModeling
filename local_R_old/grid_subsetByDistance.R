...
#' monitor_timeseriesPlot(bs_monitors, style = "gnats", ylim = c(0, 100), cex = 1.5)
#' monitor_timeseriesPlot(bs_median, type = "l", lwd = 3, col = "blue", add = TRUE)
#' monitor_timeseriesPlot(bs_mean, type = "l", lwd = 3, col = "red", add = TRUE)
